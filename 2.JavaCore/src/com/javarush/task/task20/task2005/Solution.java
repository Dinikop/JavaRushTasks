...
//            System.out.println(ivanov.name + " " + ivanov.hashCode());
//            for (Asset asset :ivanov.assets) {
//                System.out.print(asset.getName() + ":" + asset.getPrice() + " " + asset.hashCode() + " ");
//            }
//            System.out.println();
//            System.out.println(somePerson.name + " " + somePerson.hashCode());
...
//            return (int) (Math.random() * 100);
        ...
        public void load(InputStream inputStream) throws Exception {
            ...
            while ((assetName = reader.readLine()) != null) {
                if (assetName.equals("null")) break;
